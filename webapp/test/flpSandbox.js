		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#mentoriafiorikazkaui5242icsf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mentoriafiorikazkaui5242icsf-display": {
								"semanticObject": "mentoriafiorikazkaui5242icsf",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mentoria.fiori.ka.zkaui5242icsf",
									"url": sap.ui.require.toUrl("mentoria/fiori/ka/zkaui5242icsf")
								}
							}
						}
					}
